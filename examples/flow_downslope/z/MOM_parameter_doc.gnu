...
REGRIDDING_SCHEME = 0           !
                                ! Type of grid to build in the vertical.Choose among the following possibilities (must
                                ! be an integer !):
                                !  0: z*.
                                !  1: target interface densities.
                                !  2: sigma.
REMAPPING_SCHEME = 4            ! default = 1
...
INTERPOLATION_SCHEME = 8        ! default = 0
...
MIN_THICKNESS = 0.001           !   [not defined] default = 0.001
