...
!------------------------------------------------------------------------------
  ...
  real, dimension(NXMEM_,NYMEM_, NZ_,C2_), intent(inout) :: h
  real, dimension(NXMEM_,NYMEM_, NZ_), intent(inout)     :: h_aux
...
!------------------------------------------------------------------------------
  ...
  real, dimension(NXMEM_,NYMEM_, NZ_), intent(inout)   :: &
  h;     ! Current 3D grid obtained after the last time step
  real, dimension(NXMEM_,NYMEM_, NZ_), intent(inout)   :: &
  h_new; ! The new 3D grid obtained via regridding
  real, dimension(NXMEMQ_,NYMEM_, NZ_), intent(inout)  :: &
  u;     ! Zonal velocity field
  real, dimension(NXMEM_,NYMEMQ_, NZ_), intent(inout)  :: &
...
!------------------------------------------------------------------------------
  ...
  real, dimension(NXMEM_,NYMEM_,NZ_), intent(in)    :: &
