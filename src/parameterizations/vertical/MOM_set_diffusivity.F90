...
! Simmons
  if ( use_Simmons ) then
    ...
    do i=is,ie
      ...
      if ( CS%Int_tide_dissipation .or. CS%Lowmode_itidal_dissipation) then !BDM
...
subroutine set_diffusivity_init(Time, G, param_file, diag, CS, diag_to_Z_CSp, int_tide_CSp)
