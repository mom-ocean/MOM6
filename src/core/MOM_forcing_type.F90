...
subroutine register_forcing_type_diags(Time, diag, US, use_temperature, &
    handles, use_berg_fluxes, use_waves, use_cfcs, use_MARBL_tracers, &
    use_glc_runoff, use_carbon_runoff)
