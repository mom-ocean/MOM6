...
use MOM_interp_infra,    only : horiz_interp_type, horiz_interp_init, run_horiz_interp, run_new_horiz_interp
...
public :: horiz_interp_type, horiz_interp_init, run_horiz_interp, run_new_horiz_interp
