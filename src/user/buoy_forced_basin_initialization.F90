module buoy_forced_basin_initialization
!***********************************************************************
...
!*  file) buoy_forced_basin_initialize_bottom_depth, buoy_forced_basin_initialize_thickness,     *
!*  buoy_forced_basin_initialize_velocity,  buoy_forced_basin_initialize_temperature_salinity,   *
!*  buoy_forced_basin_initialize_mixed_layer_density, buoy_forced_basin_initialize_sponges,      *
!*  buoy_forced_basin_set_coord, and buoy_forced_basin_set_ref_profile.                          *
!*                                                                     *
!*    The names of these subroutines should be self-explanatory. They  *
!*  start with "buoy_forced_basin_" to indicate that they will likely have to be    *
...
public buoy_forced_basin_set_coord 
public buoy_forced_basin_initialize_sponges_southonly
...
subroutine buoy_forced_basin_set_coord(Rlay, g_prime, GV, param_file, eqn_of_state)
  ...
  ! "buoy_forced_basin_initialization.F90, buoy_forced_basin_set_coord: " // &
...
subroutine buoy_forced_basin_initialize_sponges_southonly(G, use_temperature, tv, param_file, CSp, h)
  ...
  character(len=40)  :: mod = "buoy_forced_basin_initialize_sponges_southonly" ! This subroutine's name.
