...
public channel5_initialize_topography
...
! -----------------------------------------------------------------------------
!> This subroutine sets up the channel5 test case topography.
!> channel5 is similar to channel but:
...
subroutine channel5_initialize_topography(D, G, param_file, max_depth)
  ...
  character(len=40)  :: mod = "channel5_initialize_topography" ! This subroutine's name.
...
! difference from channel 4 (default sponge): sponge spans 5 deg, instead of 2 deg, wide
...
subroutine channel5_initialize_sponges(G, GV, use_temperature, tv, param_file, CSp, h)
  ...
  real :: damp_rate, damp, spongelen = 5.0,  min_depth, nlat, dx
