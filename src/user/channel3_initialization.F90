module channel3_initialization
...
public channel3_initialize_topography
...
subroutine channel3_initialize_topography(D, G, param_file, max_depth)
  ...
  character(len=40)  :: mod = "channel3_initialize_topography" ! This subroutine's name.
...
end subroutine channel3_initialize_topography
...
end module channel3_initialization
