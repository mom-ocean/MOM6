...
public buoy_forced_basin_buoyancy_forcing, buoy_forced_basin_surface_forcing_init

type, public :: buoy_forced_basin_surface_forcing_CS ; private
...
end type buoy_forced_basin_surface_forcing_CS

contains

subroutine buoy_forced_basin_buoyancy_forcing(state, fluxes, day, dt, G, CS)
...
end subroutine buoy_forced_basin_buoyancy_forcing
...
#include "version_variable.h"
  character(len=40)  :: mod = "buoy_forced_basin_surface_forcing" ! This module's name.

  if (associated(CS)) then
    call MOM_error(WARNING, "buoy_forced_basin_surface_forcing_init called with an associated "// &
                             "control structure.")
    return
  endif
  allocate(CS)
...
end subroutine buoy_forced_basin_surface_forcing_init

end module buoy_forced_basin_surface_forcing
