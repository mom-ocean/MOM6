module channel74_initialization
...
public channel74_initialize_sponges
...
! -----------------------------------------------------------------------------
!> This subroutine sets up the channel74 test case sponge.
...
!
! difference from channel 7: use the stratification from 30S, not 32S; so only eta0 differs
!
subroutine channel74_initialize_sponges(G, GV, use_temperature, tv, param_file, CSp, h)
  ...
  character(len=40)  :: mdl = "channel74_initialize_sponges" ! This subroutine's name
...
end subroutine channel74_initialize_sponges
