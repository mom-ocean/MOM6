module channel4tt_initialization
...
public channel4tt_initialize_sponges
...
subroutine channel4tt_initialize_sponges(G, GV, use_temperature, tv, param_file, CSp, h)
  ...
  character(len=40)  :: mdl = "channel4tt_initialize_sponges" ! This subroutine's name
...
end subroutine channel4tt_initialize_sponges
...
end module channel4tt_initialization
