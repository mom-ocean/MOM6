module channel47_initialization
...
public channel47_initialize_sponges
...
subroutine channel47_initialize_sponges(G, GV, use_temperature, tv, param_file, CSp, h)
  ...
  character(len=40)  :: mdl = "channel47_initialize_sponges" ! This subroutine's name
...
end subroutine channel47_initialize_sponges
...
end module channel47_initialization
