...
!### endif
  ...
  if (CS%allow_flux_adjustments) then
    ...
    ! TODO (mvertens 5/27/2018): the following call gives an error:
    ! "The type of the actual argument differs from the type of the dummy argument [FLUXES]"
