...
implicit none
real, intent(inout) :: sppt_wts(:,:)  !< array contain random weight for SPPT range [0,2]
real, intent(inout) :: t_rp1(:,:)  !< array containing random weights for ePBL perturbations (KE generation) range [0,2]
real, intent(inout) :: t_rp2(:,:)  !< array containing random weights for ePBL perturbations (KE dissipation) range [0,2]
return
