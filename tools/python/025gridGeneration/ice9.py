...
def applyIce9(fileName, nFileName, variable, x0, y0, shallow, analyze):
  ...
  rgDepth = rg.variables[variable] # handle to the variable
  dims = rgDepth.dimensions # tuple of dimensions
  depth = rgDepth[:] # Read the data
